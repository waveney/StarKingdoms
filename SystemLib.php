...
function Show_Planet(&$P,$Mode=0,$Buts=0) {
  ...
  echo "<tr>" . fm_text('Short Name',$P,'ShortName') . fm_number('Attributes',$P,'Attributes') . "<td>1=Hide";
...
function Show_Moon(&$M,$Mode=0) {
  ...
  echo "<tr>" . fm_text('Short Name',$M,'ShortName') . fm_number('Attributes',$M,'Attributes') . "<td>1=Hide";
