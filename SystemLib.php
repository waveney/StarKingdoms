...
function Show_System(&$N,$Mode=0) {
  ...
  echo "<tr>" . fm_number('Radius',$N,'Radius',1,"class=NotCSide") . "Km" . fm_number('Mass',$N,'Mass',1,"class=NotCSide") . "Kg"
              . fm_number('Temperature',$N,'Temperature',1,"class=NotCSide") . "K" . fm_number('Luminosity',$N,'Luminosity',1,"class=NotCSide") . "W";
  if ($N['Type2']) {
    echo "<tr>" . fm_text('2nd Star Type',$N,'Type2',2,"class=NotCSide");
    echo "<tr>" . fm_number('Radius',$N,'Radius2',1,"class=NotCSide") . "Km". fm_number('Mass',$N,'Mass2',1,"class=NotCSide") . "Kg"
                . fm_number('Temperature2',$N,'Temperature2',1,"class=NotCSide") . "K" . fm_number('Luminosity',$N,'Luminosity2',1,"class=NotCSide") . "W";
    echo "<tr>" . fm_number('Distance',$N,'Distance',1,"class=NotCSide"). "Km" . fm_number('Period',$N,'Period',1,"class=NotCSide") . "Hr" ;           
  } elseif ($Mode) {
    echo "<tr>" . fm_text('2nd Star Type',$N,'Type2',2,"class=NotCSide");  
  }
