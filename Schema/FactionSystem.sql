CREATE TABLE `FactionSystem` (
  ...
  `SpaceTurn` int NOT NULL,
  `PlanetTurn` int NOT NULL,
  `SpaceSurvey` text COLLATE utf8mb4_general_ci NOT NULL,
  `PlanetSurvey` text COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
